                ...
                <div className="flex gap-2 mb-6 mt-3">
                    {
                        isEdit ?
                            <>
                                <label htmlFor="resumeUpload" className="flex items-center">
                                    ...
                                    <input type="file" accept="application/pdf" onChange={e => setResume(e.target.files[0])}
                                        id="resumeUpload" hidden />
                                    <img src={assets.profile_upload_icon} alt="Profile Upload Image" />
                                </label>
                            ...
                            <div className="flex gap-2">
                                ...
                                <button className="border border-gray-300 rounded-lg text-gray-500 px-4 py-2 cursor-pointer"
